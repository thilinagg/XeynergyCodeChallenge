        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Privilage = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PersonId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AttachedCustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NormalUsers_Customers_AttachedCustomerId",
                        column: x => x.AttachedCustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NormalUsers_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NormalUsers_UserGroups_UserGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NormalUsers_AttachedCustomerId",
                table: "NormalUsers",
                column: "AttachedCustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_NormalUsers_PersonId",
                table: "NormalUsers",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_NormalUsers_UserGroupId",
                table: "NormalUsers",
                column: "UserGroupId");
